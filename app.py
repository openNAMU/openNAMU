                    ...
                    if(results[1]):
                        ...
                        while True:
                            ...
                            if(g):
                                ...
                                break                        
                    data = re.sub("\[include\(((?:(?!\)\]|,).)*)((?:,\s?(?:[^)]*))+)?\)\]", '<div>' + enddata + '</div>', data, 1)
                else:
