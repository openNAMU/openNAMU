...
func register_list_compat_routes(r *gin.Engine) {
	...
	r.GET("/list/document/manual_category/:page", func(c *gin.Context) {
		write_data(c, http.StatusOK, "text/html; charset=utf-8", []byte(route.View_list_no_data_manual_category_page(make_route_config(c), c.Param("page"))))
	})
	r.GET("/list/category/need/:page", func(c *gin.Context) {
		write_data(c, http.StatusOK, "text/html; charset=utf-8", []byte(route.View_list_category_need_page(make_route_config(c), c.Param("page"))))
	})
	r.GET("/list/category/no_link/:page", func(c *gin.Context) {
		write_data(c, http.StatusOK, "text/html; charset=utf-8", []byte(route.View_list_category_unused_page(make_route_config(c), c.Param("page"))))
	})
	...
	r.GET("/list/file/:page", func(c *gin.Context) {
		write_data(c, http.StatusOK, "text/html; charset=utf-8", []byte(route.View_list_file_page(make_route_config(c), c.Param("page"))))
	})
	r.GET("/list/image/:page", func(c *gin.Context) {
		write_data(c, http.StatusOK, "text/html; charset=utf-8", []byte(route.View_list_image_page(make_route_config(c), c.Param("page"))))
	})
	r.POST("/list/admin/auth_use", func(c *gin.Context) {
		_ = c.Request.ParseForm()
		write_data(c, http.StatusOK, "text/html; charset=utf-8", []byte(route.View_list_admin_auth_use_page(make_route_config(c), "1", c.PostForm("search"))))
	})
	r.GET("/list/admin/auth_use_page/:page", func(c *gin.Context) {
		write_data(c, http.StatusOK, "text/html; charset=utf-8", []byte(route.View_list_admin_auth_use_page(make_route_config(c), c.Param("page"), "")))
	})
	r.POST("/list/admin/auth_use_page/:page", func(c *gin.Context) {
		_ = c.Request.ParseForm()
		write_data(c, http.StatusOK, "text/html; charset=utf-8", []byte(route.View_list_admin_auth_use_page(make_route_config(c), c.Param("page"), c.PostForm("search"))))
	})
	r.GET("/list/admin/auth_use_page/:page/*search", func(c *gin.Context) {
		search := strings.TrimPrefix(c.Param("search"), "/")
		write_data(c, http.StatusOK, "text/html; charset=utf-8", []byte(route.View_list_admin_auth_use_page(make_route_config(c), c.Param("page"), search)))
	})
	...
	r.GET("/list/admin/:page", func(c *gin.Context) {
		write_data(c, http.StatusOK, "text/html; charset=utf-8", []byte(route.View_list_admin_page(make_route_config(c), c.Param("page"))))
	})
