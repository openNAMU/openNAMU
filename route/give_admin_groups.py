                ...
                [2, 'ip', get_lang(conn, 'ip_authority')],
                    [3, 'document', get_lang(conn, 'document_authority')],
                        ...
                        [4, 'delete', get_lang(conn, 'delete_authority')],
                            [5, '', get_lang(conn, 'view_authority')],
                        [4, 'document_comment', get_lang(conn, 'document_comment_authority')],
                            [5, 'document_comment_write', get_lang(conn, 'document_comment_write_authority')],
                                [6, '', get_lang(conn, 'document_comment_view_authority')],
                            [5, 'document_comment_view', get_lang(conn, 'document_comment_view_authority')],
