...
def 기여_횟수():
    ...
    if(숫자):
        ...
        return 웹_디자인('index.html', login = 로그인_확인(), title = '기여 횟수', logo = data['name'], data = "기여 횟수 : 0")
