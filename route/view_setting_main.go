...
func View_setting_main_data(db *sql.DB, config tool.Config, values map[string]string) string {
	...
	data.WriteString(`<label for="name">` + lang("wiki_name") + `</label>` + Main_hr())
	...
	data.WriteString(`<label for="frontpage_type">` + lang("main_page") + `</label>` + Main_hr())
	data.WriteString(`<select id="frontpage_type" name="frontpage_type">` + Setting_options(values["frontpage_type"], []string{"document", "bbs"}, map[string]string{"document": lang("document"), "bbs": lang("bbs_main")}) + `</select>` + Main_hr())
	data.WriteString(`<label for="frontpage">` + lang("document_name") + `</label>` + Main_hr())
	data.WriteString(Setting_input("frontpage", values["frontpage"], "text") + Main_hr())
	data.WriteString(`<label for="http_select">` + lang("tls_method") + `</label>` + Main_hr())
	data.WriteString(`<select id="http_select" name="http_select">` + Setting_options(values["http_select"], []string{"http", "https"}, nil) + `</select>` + Main_hr())
	data.WriteString(`<label for="domain">` + lang("domain") + `</label> (EX : 2du.pythonanywhere.com) (` + lang("off") + ` : ` + lang("empty") + `)` + Main_hr())
	data.WriteString(Setting_input("domain", values["domain"], "text") + Main_hr())
	data.WriteString(`<label for="host">` + lang("wiki_host") + `</label>` + Main_hr())
	data.WriteString(Setting_input("host", values["host"], "text") + Main_hr())
	data.WriteString(`<label for="port">` + lang("wiki_port") + `</label>` + Main_hr())
	data.WriteString(Setting_input("port", values["port"], "text") + Main_hr())
	data.WriteString(`<label for="key">` + lang("wiki_secret_key") + `</label>` + Main_hr())
	...
	data.WriteString(`<label for="wiki_access_password">` + lang("set_wiki_access_password") + `</label> (` + lang("restart_required") + `)` + Main_hr())
	data.WriteString(Setting_input("wiki_access_password", values["wiki_access_password"], "password") + Main_hr())
	data.WriteString(`<label for="load_ip_select">` + lang("wiki_load_ip_select") + `</label> (` + lang("restart_required") + `)` + Main_hr())
	data.WriteString(`<select id="load_ip_select" name="load_ip_select">` + Setting_options(values["load_ip_select"], ip_values, ip_labels) + `</select>` + Main_hr())
	...
	data.WriteString(`<label for="auth_history_expiration_date">` + lang("authority_use_list_expiration_date") + `</label> (` + lang("day") + `) (` + lang("off") + ` : ` + lang("empty") + `)` + Main_hr())
	...
	data.WriteString(`<label for="bbs_excellent_min">` + lang("bbs_excellent_min") + ` (` + lang("empty") + ` : 5)</label>` + Main_hr())
	...
	data.WriteString(`<label for="skin">` + lang("wiki_skin") + `</label>` + Main_hr())
	data.WriteString(`<select id="skin" name="skin">` + Setting_options(skin_value, skin_values, nil) + `</select>` + Main_hr())
	...
	data.WriteString(`<label for="user_document_view_acl_all">` + lang("user_document_view_acl_all") + ` (` + lang("off") + ` : ` + lang("empty") + `)</label>` + Main_hr())
	...
	data.WriteString(`<label for="application_expiration_date">` + lang("application_expiration_date") + ` (` + lang("day") + `) (` + lang("off") + ` : ` + lang("empty") + `)</label>` + Main_hr())
	...
	data.WriteString(`<label for="application_expiration_action">` + lang("application_expiration_action") + `</label>` + Main_hr())
	data.WriteString(`<select id="application_expiration_action" name="application_expiration_action">` + Setting_options(values["application_expiration_action"], []string{"", "approve", "decline"}, map[string]string{"": lang("off"), "approve": lang("approve"), "decline": lang("decline")}) + `</select>` + Main_hr())
	data.WriteString(`<label for="password_min_length">` + lang("password_min_length") + `</label> (` + lang("off") + ` : ` + lang("empty") + `)` + Main_hr())
	data.WriteString(Setting_input("password_min_length", values["password_min_length"], "text") + Main_hr())
	data.WriteString(`<label for="encode">` + lang("encryption_method") + `</label>` + Main_hr())
	data.WriteString(`<select id="encode" name="encode">` + Setting_options(values["encode"], encode_values, nil) + `</select>` + Main_hr())
	...
	data.WriteString(`<label for="ua_expiration_date">` + lang("ua_expiration_date") + `</label> (` + lang("day") + `) (` + lang("off") + ` : ` + lang("empty") + `)` + Main_hr())
	...
	data.WriteString(`<label for="update">` + lang("update_branch") + `</label>` + Main_hr())
	data.WriteString(`<select id="update" name="update">` + Setting_options(values["update"], []string{"stable", "beta"}, nil) + `</select>` + Main_hr())
	...
	data.WriteString(`<label for="back_up">` + lang("backup_interval") + ` (` + lang("hour") + `) (` + lang("off") + ` : ` + lang("empty") + `)</label>` + Main_hr())
	data.WriteString(Setting_input("back_up", values["back_up"], "text") + Main_hr())
	data.WriteString(`<label for="backup_where">` + lang("backup_where") + ` (` + lang("default") + ` : ` + lang("empty") + `) (` + lang("example") + ` : ./data/backup.db)</label>` + Main_hr())
	data.WriteString(Setting_input("backup_where", values["backup_where"], "text") + Main_hr())
	data.WriteString(`<label for="backup_count">` + lang("backup_count") + ` (` + lang("default") + ` : ` + lang("empty") + `)</label>` + Main_hr())
	...
	data.WriteString(`<label for="slow_edit">` + lang("slow_edit") + ` (` + lang("second") + `) (` + lang("off") + ` : ` + lang("empty") + `)</label>` + Main_hr())
	...
	data.WriteString(`<label for="title_max_length">` + lang("title_max_length") + ` (` + lang("off") + ` : ` + lang("empty") + `)</label>` + Main_hr())
	data.WriteString(Setting_input("title_max_length", values["title_max_length"], "text") + Main_hr())
	data.WriteString(`<label for="title_topic_max_length">` + lang("title_topic_max_length") + ` (` + lang("off") + ` : ` + lang("empty") + `)</label>` + Main_hr())
	data.WriteString(Setting_input("title_topic_max_length", values["title_topic_max_length"], "text") + Main_hr())
	data.WriteString(`<label for="upload">` + lang("max_file_size") + ` (MB)</label>` + Main_hr())
	...
	data.WriteString(`<label for="slow_thread">` + lang("slow_thread") + ` (` + lang("second") + `) (` + lang("off") + ` : ` + lang("empty") + `)</label>` + Main_hr())
	data.WriteString(Setting_input("slow_thread", values["slow_thread"], "text") + Main_hr())
	data.WriteString(`<label for="edit_timeout">` + lang("edit_timeout") + ` (` + lang("second") + `) (` + lang("off") + ` : ` + lang("empty") + `) (` + lang("linux_only") + `)</label>` + Main_hr())
	data.WriteString(Setting_input("edit_timeout", values["edit_timeout"], "text") + Main_hr())
	data.WriteString(`<label for="document_content_max_length">` + lang("document_content_max_length") + ` (` + lang("off") + ` : ` + lang("empty") + `)</label>` + Main_hr())
	data.WriteString(Setting_input("document_content_max_length", values["document_content_max_length"], "text") + Main_hr())
	data.WriteString(`<label for="bbs_content_max_length">` + lang("bbs_content_max_length") + ` (` + lang("off") + ` : ` + lang("empty") + `)</label>` + Main_hr())
