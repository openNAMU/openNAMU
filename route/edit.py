...
def edit(name='Test', name_load=0, section=0):
    with get_db_connect() as conn:
        ...
        if edit_repeat == 'post':
            if captcha_post(
                    flask.request.form.get('g-recaptcha-response', flask.request.form.get('g-recaptcha', ''))) == 1:
            ...
            if edit_repeat == 'get':
                ...
                if flask.request.form.get('ver', '0') == '0':
                    ...
                    warning_edit += '<a href="/diff/' + flask.request.form.get('ver', '1') + '/' + doc_ver + '/' + url_pas(name) + '">' + \
                                    '(r' + doc_ver + ')' + \
                                    '</a>' + \
                                    ''
